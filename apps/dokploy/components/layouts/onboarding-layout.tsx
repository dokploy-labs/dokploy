...
export const OnboardingLayout = ({ children, leftPanel }: Props) => {
	...
	const appDescription =
		...
		"\u201CPlataforma de Despliegue Continuo de Aplicaciones Académicas\u201D";
	const logoUrl =
	...
	return (
		<div className="container relative min-h-svh flex-col items-center justify-center flex lg:max-w-none lg:grid lg:grid-cols-2 lg:px-0 w-full">
			<div className="relative hidden h-full flex-col dark:border-r lg:flex">
				{/* Parte superior */}
				<div className="relative z-20 bg-white p-10 h-56 shadow-sm">
					<Link href="/" className="flex items-center">
						<img
							src="/images/logo-hurlingham.png"
							alt="UNAHUR"
				...
				{/* Parte inferior */}
				<div
					className="relative flex-1 p-10 text-white flex flex-col"
						...
						{leftPanel ?? (
							<>
								...
								<p className="text-sm text-white/90">
									UNAHUR | Innovación y Tecnología al servicio de la educación
									pública
								</p>
							</>
						)}
